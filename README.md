...
```sql
SELECT course.course_name AS 課名, teacher.teacher_name AS 授課教師, SUM(course_record.feedback_rank) AS 教學評量總分, ROUND(AVG(course_record.feedback_rank), 1) AS 教學評量平均分數
